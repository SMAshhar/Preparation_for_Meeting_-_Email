...
marketing_email_writer_agent = agents.marketing_email_writer_agent()
...
marketing_email_writer = tasks.marketing_email_writer_task(marketing_email_writer_agent, participants, context)
